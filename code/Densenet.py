...
class DenseNet(nn.Module):
    ...
    def __init__(self, growth_rate=12, block_config=(16, 16, 16), compression=0.5,
                 ...
                 num_classes=2, small_inputs=True, efficient=False,feat_dim=50,input_dim=1):
        ...
        if small_inputs:
            self.features = nn.Sequential(OrderedDict([
                ('conv0', nn.Conv2d(input_dim, num_init_features, kernel_size=3, stride=1, padding=1, bias=False)),
            ]))
        else:
            self.features = nn.Sequential(OrderedDict([
        ...
        # Linear layer
        self.classifier1 = nn.Linear(num_features, feat_dim)
